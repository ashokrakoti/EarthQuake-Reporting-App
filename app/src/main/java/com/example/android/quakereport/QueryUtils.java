...
public final class QueryUtils {
    ...
    private static final String LOCATION_SEPARATOR = " of ";
         ...
         */
        public static ArrayList<EarthQuake> extractEarthquakes(String off_loc_def) {
                ...
                // build up a list of Earthquake objects with the corresponding data.
                    ...
                    for (int i = 0; i<jsonArray.length(); i++) {
                        ...
                        if(place.contains(LOCATION_SEPARATOR)){
                            ...
                            location_offset = off_loc_def; // this string is used from the strings.xml
                        ...
                        earthquakes.add(new EarthQuake(location_offset,location_primary, magnitude, dateToDisplay, timeToDisplay));
                    }
